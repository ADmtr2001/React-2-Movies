...
const Search = () => {
  ...
  return (
    <Wrapper>
      ...
      {movies.length !== 0 && <MovieSliderList movies={movies} title={'Movies'} isLoading={moviesIsLoading}/>}
      {shows.length !== 0 && <MovieSliderList movies={shows} title={'Shows'} isLoading={showsIsLoading}/>}
